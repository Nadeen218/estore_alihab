    ...
    showDialog(
      ...
      builder: (dialogContext) => Directionality(
        ...
        child: AlertDialog(
          ...
          content: Text(
            isArabic
                ? "للوصول إلى هذه الخدمة وإتمام الطلب، يرجى تسجيل الدخول أو إنشاء حساب جديد."
                : "To access this feature and complete your request, please log in or create a new account.",
            textAlign: TextAlign.center,
            style: TextStyle(
